...
class M_barang_melting_masuk extends CI_Model {
    ...
    public function get($id = null){
        ...
        $sql = "
            SELECT a.*,b.nama_suplier,c.kode_barang,c.nama_barang,c.satuan FROM tb_barang_masuk a
    ...
    public function add($data)
    {
        ...
        $sql = "
        INSERT INTO `tb_barang_melting_masuk`(`no_batch`, `tgl`, `id_barang`, `id_suplier`, `status`, `qty`, `created_at`, `created_by`, `updated_at`, `updated_by`, `is_deleted`) 
        VALUES ('$data[no_batch]','$data[tgl]','$data[id_barang]','$data[id_suplier]','$data[status]','$data[qty]',NOW(),'$id_user','0000-00-00 00:00:00','','0')
        ";
        return $this->db->query($sql);
    }
    ...
    public function delete($data)
    {
        ...
        $sql = "
        DELETE FROM `tb_barang_melting_masuk`
         WHERE `id_barang_masuk`='$data[id_barang_masuk]'
        ";
        return $this->db->query($sql);
    }
