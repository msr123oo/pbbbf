...
class M_barang_keluar extends CI_Model {
    ...
    public function data_barang_keluar($no_surat_jalan){
        $sql = "
            SELECT a.*,c.nama_barang,c.satuan,c.mesh,d.nama_suplier FROM tb_barang_keluar a
    ...
    public function add_barang_keluar($data)
    {
        $id_user = $this->id_user();
        $sql = "
        INSERT INTO `tb_barang_keluar`(`no_batch`, `no_surat_jalan`, `qty`, `exp`, `created_at`, `created_by`, `updated_at`, `updated_by`, `is_deleted`)
