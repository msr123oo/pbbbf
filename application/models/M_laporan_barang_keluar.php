...
class M_laporan_barang_keluar extends CI_Model {
    ...
    public function get($tgl = null,$tgl2 = null){
        ...
        $sql = "
            SELECT a.*,c.*,b.nama_customer,e.nama_barang,e.satuan FROM tb_barang_keluar a
    ...
    public function add_barang_keluar($data)
    {
        $id_user = $this->id_user();
        $sql = "
        INSERT INTO `tb_barang_keluar`(`no_batch`, `no_surat_jalan`, `qty`, `created_at`, `created_by`, `updated_at`, `updated_by`, `is_deleted`)
