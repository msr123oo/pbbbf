...
<body>
  ...
  <div style="text-align: center;padding-top: 5px;">
    <h3 style="float: center;line-height: 0.2;font-size: 24px;"><u>&nbsp;SURAT JALAN&nbsp;</u></h3>
    ...
    <div style="border: 0; width: 70%;padding: 0;">
      <table id="jj" style="margin:0">
        <tr>
          <td class="jdl"></td><td class="td">&nbsp;&nbsp;</td><td class="jdl"></td>
        </tr>
        <tr>
          <td class="jdl">Customer</td><td>:&nbsp;&nbsp;</td><td class="jdl"><?=$row['nama_customer']?></td>
        </tr><br>
        <tr>
          <td class="jdl">Alamat</td><td>:&nbsp;&nbsp;</td><td class="jdl"><?=$row['alamat']?></td>
        </tr><br>
        <tr>
          <td class="jdl">No. SPPB</td><td>:&nbsp;&nbsp;</td><td class="jdl"><?=$row['no_sppb']?></td>
        </tr><br>
        <tr>
          <td class="jdl">No. PO</td><td>:&nbsp;&nbsp;</td><td class="jdl"><?=$row['no_po']?></td>
        </tr>
      </table>
    </div>
    <br>
<table style="width: 1000px;font-size: 20px;text-align: center;">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td ><?=$exp?></td>
                <td style="text-align: center;"><?=$zak?></td>
            ...
            <tfoot>
                                                        <tr>
                                                          <td colspan="5"><b>Jumlah</b></td><td style="text-align: center;"><b><?=$tzak?></b></td><td style="text-align: right;"><b><?=$jml?>&nbsp;<?=$key['satuan']?></b></td>
                                                        </tr>
                                                    </tfoot>
          </table>
