                                ...
                                <div class="col-md-12 col-xl-4">
                                    <div class="row">
                                            ...
                                            <div class="card daily-sales">
                                                <div class="card-block">
                                                    ...
                                                    <div class="row d-flex align-items-center">
                                                        <div class="col-9">
                                                            <h3 class="f-w-300 d-flex align-items-center m-b-0"><i class="feather icon-box text-c-green f-30 m-r-10"></i><?=$tot_barang?></h3>
                                                        </div>
                                        ...
                                        <div class="col-md-6 col-xl-12">
                                            <div class="card daily-sales">
                                                <div class="card-block">
                                                    ...
                                                    <div class="row d-flex align-items-center">
                                                        <div class="col-9">
                                                            <h3 class="f-w-300 d-flex align-items-center m-b-0"><i class="feather icon-download text-c-yellow f-30 m-r-10"></i><?=$tot_supplier?></h3>
                                                        </div>
                                        ...
                                        <div class="col-md-6 col-xl-12">
                                            <div class="card daily-sales">
                                                <div class="card-block">
                                                    <h6 class="mb-4">Total Customer</h6>
                                                    <div class="row d-flex align-items-center">
                                                        <div class="col-9">
                                                            <h3 class="f-w-300 d-flex align-items-center m-b-0"><i class="feather icon-users text-c-blue f-30 m-r-10"></i><?=$tot_customer?></h3>
                                                        </div>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                foreach ($users as $key) {
                                                                    if ($key['level']=='0') {
                                                                        ...
                                                                        $level = '<a href="#!" class="label theme-bg2 text-white f-12">User Biasa</a>';
                                                                        $o='blue';
                                                                    }
                                                                ?>
                                                                <tr class="unread">
