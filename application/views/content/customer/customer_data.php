                                                            ...
                                                            <td class="text-right">
                                                              <div class="btn-group" role="group" aria-label="Basic example">
                                                                <button type="button" 
                                                                  ...
                                                                  data-kode="<?=$k['kode_customer']?>"
                                                                  data-nama="<?=$k['nama_customer']?>"
                                                                  data-phone="<?=$k['phone']?>"
                                                                ...
                                                                <a  
                                                                  href="<?=base_url()?>customer/delete/<?=$k['id_customer']?>" 
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		    ...
		    <input type="text" class="form-control" id="" name="kode" placeholder="Kode Customer" maxlength="20">
		  </div>
		  <div class="form-group">
		    <label for="exampleFormControlInput1">Nama</label>
		    <input type="text" class="form-control" id="" name="nama" placeholder="Nama Customer" maxlength="100">
		  </div>
		  <div class="form-group">
		    <label for="exampleFormControlInput1">Phone</label>
		    <input type="text" class="form-control" id="" name="phone" placeholder="Example:02112345678" onkeypress="return hanyaAngka(event)" maxlength="15">
		  </div>
		  <div class="form-group">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <div class="form-group">
            <label for="exampleFormControlInput1">Phone</label>
            <input type="text" class="form-control" id="e_phone" name="phone" placeholder="Example:02112345678" onkeypress="return hanyaAngka(event)" maxlength="15">
          </div>
          <div class="form-group">
            <label for="exampleFormControlTextarea1">Alamat</label>
