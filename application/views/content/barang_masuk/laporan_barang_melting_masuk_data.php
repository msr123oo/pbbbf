                                ...
                                <div class="col-xl-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <h5>Data Barang melting Masuk</h5>
                                              ...
                                              <div class="input-group">
                                                ...
                                                ?>
                                                        ...
                                                        <div class="input-group-append">
                                                            ...
                                                            <a href="<?=base_url()?>laporan_barang_melting_masuk" style="width: 40px;" class="btn btn-warning" id="export" type="button"><i class="feather icon-refresh-ccw"></i></a>
                                                        </div>
                                                    </div>
                                        </div>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table datatable table-hover table-striped table-sm">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        if ($k['tot_barang_melting_keluar']==0) {
                                                          $ds="";
                                                        }else{
                                                          $ds="d-none";
                                                        }
                                                    	...
                                                    	<tr>
                                                            ...
                                                            <td class="text-right"><?=number_format($k['tot_barang_melting_keluar'],0,",",".")?><?=$k['satuan']?></td>
  ...
  $(document).ready(function() {
    ...
    $('#lihat').click(function () {
      ...
      if (filter_tgl =='' && filter_tgl2 !='') {
        window.location = "<?=base_url()?>laporan_barang_melting_masuk?alert=warning&msg=dari tanggal belum diisi";
      alert("dari tanggal belum diisi")
      }else if (filter_tgl !='' && filter_tgl2=='') {
        window.location = "<?=base_url()?>laporan_barang_melting_masuk?alert=warning&msg=sampai tanggal belum diisi";
      }else if (filter_tgl =='' && filter_tgl2=='') {
        window.location = "<?=base_url()?>laporan_barang_melting_masuk?alert=warning&msg=form periode harus diisi";
      }else{
        ...
        window.location = "<?=base_url()?>laporan_barang_melting_masuk/index/"+newFilterTgl+"/"+newFilterTgl2;
    ...
    $('#export').click(function () {
      ...
      alert("dari tanggal belum diisi")
        ...
        var url = "<?=base_url()?>laporan_barang_melting_masuk/pdf_laporan_barang_masuk";
        window.open(url, 'pdf_laporan_barang_masuk', 'location=yes,height=700,width=1300,scrollbars=yes,status=yes');
      }else{
        var url = "<?=base_url()?>laporan_barang_melting_masuk/pdf_laporan_barang_masuk/"+filter_tgl.split("/")[2]+"-"+filter_tgl.split("/")[1]+"-"+filter_tgl.split("/")[0]+"/"+filter_tgl2.split("/")[2]+"-"+filter_tgl2.split("/")[1]+"-"+filter_tgl2.split("/")[0];
        window.open(url, 'pdf_laporan_barang_masuk', 'location=yes,height=700,width=1300,scrollbars=yes,status=yes');
      }
    })
