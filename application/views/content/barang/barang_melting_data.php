                            ...
                            <div class="row align-items-center">
                                <div class="col-md-12">
                                    ...
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="javascript:">Barang Melting</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                                    	...
                                                    	<tr>
                                                            ...
                                                            <td class="text-right">
                                                              <div class="btn-group" role="group" aria-label="Basic example">
                                                                ...
                                                                <a  
                                                                  href="<?=base_url()?>barang_melting/delete/<?=$k['id_barang']?>" 
...
<div class="modal fade" id="add" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form method="post" action="<?=base_url()?>barang_melting/add">
      <div class="modal-body">
		  ...
		  <div class="form-group">
		    ...
		    <input type="text" class="form-control" id="" name="mesh" placeholder="Mesh Barang" onkeypress="return hanyaAngka(event)" maxlength="15" required>
		  </div>
      <!-- <div class="form-group">
        ...
        <input type="text" class="form-control" id="" name="bloom" placeholder="Example:02112345678" onkeypress="return hanyaAngka(event)" maxlength="15" required>
      </div>
      </div>
...
<div class="modal fade" id="edit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form method="post" action="<?=base_url()?>barang_melting/update">
      <div class="modal-body">
            <div class="form-group">
            <label for="exampleFormControlInput1">Kode</label>
