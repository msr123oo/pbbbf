                                                            ...
                                                            <td class="text-right">
                                                              <div class="btn-group" role="group" aria-label="Basic example">
                                                                ...
                                                                <a  
                                                                  ...
                                                                  onclick = "window.open(`<?=base_url()?>barang_melting_keluar_data/pdf_surat_jalan/<?=str_replace('/', '--',$k['no_surat_jalan'])?>`, 'pdf_laporan_barang_stok', 'location=yes,height=700,width=1300,scrollbars=yes,status=yes'); "
                                                                >
                                                                  <i class="feather icon-file"></i>Surat Jalan
                                                                </a>
                                                                <a  
                                                                  href="<?=base_url()?>barang_melting_keluar_data/delete/<?=str_replace('/', '--',$k['no_surat_jalan'])?>" 
...
<script type="text/javascript">
  $(document).ready(function() {
    $('#export').click(function () {
      ...
      if (filter_tgl=='') {
        window.location = "<?=base_url()?>laporan_barang_melting_stok/pdf_laporan_barang_melting_stok";
      }else{
        var url = "<?=base_url()?>laporan_barang_melting_stok/pdf_laporan_barang_melting_stok/"+filter_tgl.split("/")[2]+"-"+filter_tgl.split("/")[1]+"-"+filter_tgl.split("/")[0];
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Tambah Barang melting Keluar</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <form method="post" action="<?=base_url()?>barang_melting_keluar_data/add">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <div id="validationServer03Feedback" class="invalid-feedback">
                Maaf nomor surat jalan sudah ada.
              </div>
            </div>
          </div>
          <div class="col-md-6">
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <select class="form-control chosen-select" id="id_customer" name="id_customer" required>
                ...
                ?>
                <option value="<?=$b['id_customer']?>"><?=$b['nama_customer']?></option>
                <?php
                  }
                ?>
              </select>
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="no_sppb" name="no_sppb"  value="../KN-G/VI/22"  aria-describedby="validationServer03Feedback" required>
            </div>
            <div id="validationServer03Feedback" class="invalid-feedback">
                Maaf nomor SPPB sudah ada.
              </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $("#no_surat_jalan").keyup(function(){
      ...
      jQuery.ajax({
        url: "<?=base_url()?>barang_melting_keluar_data/cek_surat_jalan",
        dataType:'text',
        type: "post",
    ...
    $("#no_sppb").keyup(function(){
      ...
      jQuery.ajax({
        url: "<?=base_url()?>barang_melting_keluar_data/cek_sppb",
        dataType:'text',
        type: "post",
...
<div class="modal fade" id="view" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <form method="post" action="<?=base_url()?>barang_melting_masuk/update">
      ...
      <div class="modal-body">
        ...
        <div class="table-responsive">
          <table class="table table-bordered table-sm">
            ...
            <tbody id="v-barang_melting_keluar_data">
            </tbody>
          </table>
        </div>
...
$(document).ready(function() {
  ...
  $(this).find('#v-no_po').val(no_po)
    jQuery.ajax({
        url: "<?=base_url()?>barang_melting_keluar_data/data_barang_keluar",
        dataType:'json',
        type: "post",
        data:{no_surat_jalan:no_surat_jalan},
        success:function(response){
          ...
          var $id = $('#v-barang_melting_keluar_data');
          $id.empty();
