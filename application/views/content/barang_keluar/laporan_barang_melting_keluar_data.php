                                              ...
                                              <div class="input-group">
                                                ...
                                                ?>
                                                        ...
                                                        <div class="input-group-append">
                                                            ...
                                                            <a href="<?=base_url()?>laporan_barang_melting_keluar_data" style="width: 40px;" class="btn btn-warning" id="export" type="button"><i class="feather icon-refresh-ccw"></i></a>
                                                        </div>
                                                    </div>
                                            </div>
                                        </div>
                                                    	...
                                                    	<tr>
                                                            ...
                                                            <!-- <td class="text-right">
                                                              <div class="btn-group" role="group" aria-label="Basic example">
                                                                ...
                                                                <a  
                                                                  href="<?=base_url()?>barang_melting_masuk/delete/<?=$k['id_barang_masuk']?>" 
  ...
  $(document).ready(function() {
    $('#lihat').click(function () {
      ...
      if (filter_tgl =='' && filter_tgl2 !='') {
        window.location = "<?=base_url()?>laporan_barang_melting_keluar_data?alert=warning&msg=dari tanggal belum diisi";
      alert("dari tanggal belum diisi")
      }else if (filter_tgl !='' && filter_tgl2=='') {
        window.location = "<?=base_url()?>laporan_barang_melting_keluar_data?alert=warning&msg=sampai tanggal belum diisi";
      }else if (filter_tgl =='' && filter_tgl2=='') {
        window.location = "<?=base_url()?>laporan_barang_melting_keluar_data?alert=warning&msg=form periode harus diisi";
      }else{
        ...
        window.location = "<?=base_url()?>laporan_barang_melting_keluar_data/index/"+newFilterTgl+"/"+newFilterTgl2;
      }
    })
    $('#export').click(function () {
     ...
     if (filter_tgl =='' && filter_tgl2 !='') {
      ...
      alert("dari tanggal belum diisi")
        ...
        var url = "<?=base_url()?>laporan_barang_melting_keluar_data/pdf_laporan_barang_melting_keluar";
        window.open(url, 'pdf_laporan_barang_melting_keluar', 'location=yes,height=700,width=1300,scrollbars=yes,status=yes');
      }else{
        var url = "<?=base_url()?>laporan_barang_melting_keluar_data/pdf_laporan_barang_melting_keluar/"+filter_tgl.split("/")[2]+"-"+filter_tgl.split("/")[1]+"-"+filter_tgl.split("/")[0]+"/"+filter_tgl2.split("/")[2]+"-"+filter_tgl2.split("/")[1]+"-"+filter_tgl2.split("/")[0];
        window.open(url, 'pdf_laporan_barang_melting_keluar', 'location=yes,height=700,width=1300,scrollbars=yes,status=yes');
      }
    })
