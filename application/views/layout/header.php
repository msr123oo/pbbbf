  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <input type="text" class="form-control" id="e_nama" name="nama" value="<?=$this->session->userdata('nama')?>" maxlength="100"  readonly>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <label for="exampleFormControlInput1">Level ( 0 = Admin , 1 = User Biasa )</label>
