...
class Barang_melting_stok extends CI_Controller {
	...
	public function index()
	{
        ...
        for($i=0; $i<count($data['result']);$i++){
            ...
            $jml_barang_masuk = $this->M_barang_melting_masuk->jml_barang_masuk($d)->row_array();
            $jml_barang_keluar = $this->M_barang_melting_keluar->jml_barang_keluar2($d)->row_array();
            // $a=0;
		...
		$this->template->load('template', 'content/barang/barang_melting_stok',$data);
        // print_r($data);
